...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/videos/1.mp4', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--nosave', action='store_false', help='do not save images/videos')   # store_true为保存视频或者图片，路径为runs/detect
